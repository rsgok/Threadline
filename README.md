...
Download **Threadline 0.3.2** for Apple Silicon from [GitHub Releases](https://github.com/rsgok/Threadline/releases/tag/0.3.2), unzip it, and move `Threadline.app` to Applications. First launch downloads its own Node runtime from nodejs.org and the matching signed interface/service package from GitHub. Once prepared, installed components work offline; no npm, Python or developer tools are required for this installation.
